 ...
 *   baseline 0.0301 (hit 0.083)
 *   tuned    0.5952 (hit 0.764)
 */
...
export const TUNING_META = {
  tunedAt: "2026-08-30T18:01:32.582Z" as string | null,
  goldSetSize: 24,
  baseline: 0.0301 as number | null,
  final: 0.5952 as number | null,
};
